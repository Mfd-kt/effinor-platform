  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          teamManagerOnly
            ? "Créer des comptes pour votre équipe (rôles agent ou closer) et consulter les membres rattachés à vos équipes. Les actions sensibles restent réservées au super administrateur."
