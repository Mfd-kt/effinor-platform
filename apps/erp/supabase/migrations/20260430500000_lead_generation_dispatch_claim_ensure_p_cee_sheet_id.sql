-- Réparation : l’app appelle dispatch_lead_generation_stock_claim avec p_cee_sheet_id.
-- Si la migration 20260430480000 n’a pas été appliquée sur la base, PostgREST renvoie :
-- « Could not find the function ... (..., p_cee_sheet_id, ...) in the schema cache ».
-- Ce fichier est idempotent : remplace la surcharge attendue par le client.
