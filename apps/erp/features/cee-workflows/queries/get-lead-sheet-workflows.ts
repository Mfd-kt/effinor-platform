...
export async function getLeadSheetWorkflowsForAccess(
  ...
  const selectClause = `
    *,
    lead:leads!lead_id(id, created_at, company_name, lead_status, cee_sheet_id, current_workflow_id, contact_name, phone, email, worksite_address, worksite_city, worksite_postal_code, recording_notes, lead_channel, lead_origin, callback_at, deleted_at),
