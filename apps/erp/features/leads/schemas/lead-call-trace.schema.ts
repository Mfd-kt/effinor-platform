...
const uuid = z.string().uuid("Identifiant lead invalide.");

export const updateLeadCallTraceSchema = z
  .object({
    leadId: uuid,
...
export type UpdateLeadCallTraceInput = z.infer<typeof updateLeadCallTraceSchema>;
