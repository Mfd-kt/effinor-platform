...
import { updateLeadCallTraceAction } from "@/features/leads/actions/update-lead-call-trace-action";
...
export type LeadAircallCallSectionProps = {
  leadId: string;
  phone: string | null;
  readOnly: boolean;
  initial: {
...
export function LeadAircallCallSection({ leadId, phone, readOnly, initial }: LeadAircallCallSectionProps) {
  ...
  function submit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      const res = await updateLeadCallTraceAction({
        leadId,
      ...
      <div className="border-t border-border pt-5">
        ...
        <form onSubmit={submit} className="mt-4 grid gap-4 sm:grid-cols-2">
          <div className="space-y-1.5 sm:col-span-2">
            <Label htmlFor="lg-call-status">Dernier statut d’appel</Label>
            <Select
              value={status}
              onValueChange={(v) => {
              ...
              disabled={readOnly}
            >
              <SelectTrigger id="lg-call-status" className="w-full max-w-md">
          ...
          <div className="space-y-1.5">
            <Label htmlFor="lg-call-at">Date du dernier appel</Label>
            <Input
              id="lg-call-at"
              type="datetime-local"
              value={callAt}
          ...
          <div className="space-y-1.5 sm:col-span-2">
            <Label htmlFor="lg-call-note">Note d’appel</Label>
            <Textarea
              id="lg-call-note"
              value={note}
          ...
          <div className="space-y-1.5 sm:col-span-2">
            <Label htmlFor="lg-call-rec">Lien d’enregistrement (optionnel)</Label>
            <Input
              id="lg-call-rec"
              type="url"
              inputMode="url"
