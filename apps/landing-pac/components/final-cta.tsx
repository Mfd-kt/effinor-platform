      ...
      <Container size="site">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-3 text-3xl font-bold tracking-tight sm:text-4xl lg:text-5xl">
            Étude gratuite sous 24 h
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-relaxed text-primary-100 sm:text-lg">
            Répondez aux 6 questions du simulateur — un conseiller Effinor vous recontacte
            sous 24 h ouvrées avec une estimation précise de vos aides.
          </p>
