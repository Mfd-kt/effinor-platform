...
export function MidCta() {
  return (
    <Section spacing="sm" className="bg-gradient-to-r from-accent-500 via-accent-500 to-accent-600 text-white">
      <Container size="site">
        <div className="flex flex-col items-center gap-6 py-4 text-center lg:flex-row lg:justify-between lg:text-left">
          <div>
            ...
            <h2 className="mt-1 text-2xl font-bold tracking-tight sm:text-3xl">
              Divisez votre facture de chauffage par 3 dès le mois prochain
            </h2>
            <p className="mt-2 max-w-2xl text-sm text-accent-50 sm:text-base">
              Devis gratuit sous 24 h. Étude technique offerte. Aides maximales
              déduites directement — 0 € à avancer.
            </p>
          </div>
