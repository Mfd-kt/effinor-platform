...
export default [
	{
		ignores: [
			...
			'dist/**',
			'build/**',
			'destratificateur-FIXED-*/**',
			'destratificateur-NOCACHE-FIX/**',
			'destratificateur-FTP-*/**',
			'Landing_destratificateur-*/**',
			'Landing_destratificateur-DEPLOY-FTP-*/**',
			'Landing_destratificateur_deploy*/**',
			'vite.config.js'
		]
	},
	{
