import { Award, Hammer, ShieldCheck, TrendingUp } from 'lucide-react'
...
const ITEMS = [
  {
    Icon: Hammer,
    value: '2 500+',
    label: 'Maisons rénovées',
    sublabel: 'Foyers accompagnés depuis 2018',
  },
  {
    Icon: TrendingUp,
    value: '2 classes',
    label: 'Saut DPE minimum',
    sublabel: 'Garanti par le dispositif BAR-TH-174',
  },
  {
    Icon: Award,
    value: 'RGE',
    label: 'QualiBat · QualiPAC',
    sublabel: 'Artisans certifiés salariés',
  },
  {
    Icon: ShieldCheck,
    value: '10 ans',
    label: 'Garantie décennale',
    sublabel: "SAV local sous 48 h ouvrées",
  },
] as const
